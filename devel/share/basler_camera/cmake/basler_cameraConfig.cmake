...
if(NOT "/home/luan/husky_ur5/src/basler_camera/include " STREQUAL " ")
  set(basler_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/luan/husky_ur5/src/basler_camera/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'basler_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luan/husky_ur5/src/basler_camera/${idir}'.  Ask the maintainer 'Shadow Robot's software team <software@shadowrobot.com>' to fix it.")
    endif()
